package com.app.petcare_backend.model;
...
import com.app.petcare_backend.converter.DurationConverter;
import com.app.petcare_backend.converter.UUIDToByteConverter;
import com.app.petcare_backend.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"petcare_backend\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"petcare_backend\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"petcare_backend\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"petcare_backend\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"petcare_backend\"")
